...
describe "GameController" do
  ...
  let!(:game1) {GameController.new(board1, bob, c3po)}
  let!(:game2) {GameController.new(board2, bob, c3po)}
  let!(:game21) {GameController.new(board21, bob, c3po)}
  let!(:game3) {GameController.new(board3, bob, c3po)}
  let!(:game31) {GameController.new(board31, bob, c3po)}
  let!(:game32) {GameController.new(board32, bob, c3po)}
  let!(:game4) {GameController.new(board4, bob, c3po)}
  let!(:game41) {GameController.new(board41, bob, c3po)}
  let!(:game42) {GameController.new(board42, bob, c3po)}
  let!(:won_game) {GameController.new(won_board, bob, c3po)}
  let!(:tie_game) {GameController.new(tie_board, bob, c3po)}
